...
module ShopOnRails
  ...
  class Installer < Thor::Group
    ...
    desc 'Creates a new rails project with a spree store and refinerycms plus the Spreefinery Themes Engine'
    ...
    class_option :version, :type => :string, :desc => 'ShopOnRails Version to use'

    class_option :edge, :type => :boolean

    class_option :path, :type => :string, :desc => 'ShopOnRails gem path'
    class_option :git, :type => :string, :desc => 'ShopOnRails gem git url'
    class_option :ref, :type => :string, :desc => 'ShopOnRails gem git ref'
    class_option :branch, :type => :string, :desc => 'ShopOnRails gem git branch'
    class_option :tag, :type => :string, :desc => 'ShopOnRails gem git tag'
